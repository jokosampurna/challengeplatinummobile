...
WebUI.callTestCase(findTestCase('Page/Register/Verify Content'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Page/Login/Input Email'), [('email') : 'agung@gmail.com'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Page/Login/Input Password'), [('pasword') : 'agungnih'], FailureHandling.STOP_ON_FAILURE)
